...
public class MuteNotification extends Notification {
     ...
     */
    public MuteNotification(String sender, String receiver, String info) {
        super(sender, receiver, info, "mute", false);
    }
    ...
    public static Notification make(String sender, String receiver, String info) {
        return new MuteNotification(sender, receiver, info);
    }
}
